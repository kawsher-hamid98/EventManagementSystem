...
public class UserDetailsServiceImpl implements UserDetailsService, UserService {
	...
	public void makePdf(String username, String eventId, List<SubEvent> subEventList) throws FileNotFoundException, DocumentException {
		...
		com.itextpdf.text.Paragraph p6 = new com.itextpdf.text.Paragraph("Ordered By: " + user.getName());
...
//            cell2.setHorizontalAlignment(Element.ALIGN_RIGHT);
	...
	@Override
	public void makePdfForFreeEvent(String username, String eventId) throws DocumentException, FileNotFoundException {
		User user = userRepository.findUserByUsername(username);
		GeneralEvent generalEvent = generalEventRepository.findGeneralEventById(eventId);

		System.out.println("User Name: " + user.getUsername());
		System.out.println("Event Name: " + generalEvent.getEventName());
		...
		Chunk blueText = new Chunk("Event Go", blue);
		Font eventName = new Font(Font.FontFamily.HELVETICA, 15, Font.BOLD, BaseColor.BLACK);
		Chunk eventNameText = new Chunk(generalEvent.getEventName(), eventName);

		com.itextpdf.text.Paragraph p1 = new com.itextpdf.text.Paragraph(blueText);
		p1.setAlignment(Element.ALIGN_CENTER);
		com.itextpdf.text.Paragraph p2 = new com.itextpdf.text.Paragraph(eventNameText);
		com.itextpdf.text.Paragraph p3 = new com.itextpdf.text.Paragraph(generalEvent.getEventAddress());
		com.itextpdf.text.Paragraph p4 = new com.itextpdf.text.Paragraph(generalEvent.getDate());
		com.itextpdf.text.Paragraph p5 = new com.itextpdf.text.Paragraph("Ticket No: " + fileName);
		com.itextpdf.text.Paragraph p6 = new com.itextpdf.text.Paragraph("Ordered By: " + user.getName());
		Font eventInfo = new Font(Font.FontFamily.HELVETICA, 12, Font.ITALIC, BaseColor.DARK_GRAY);
		Chunk eventInfoText = new Chunk(generalEvent.getEventDescription(), eventInfo);
		com.itextpdf.text.Paragraph p7 = new com.itextpdf.text.Paragraph(eventInfoText);
